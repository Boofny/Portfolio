function About(){
  return(
    <div className="flex justify-center items-center p-5 w-250 h-100 m-20 flex-col gap-y-5 rounded bg-OneDarkGray border-2 border-OneGreen">
      ...
      <div className="w-full h-full flex justify-center items-top text-OneWhite font-semibold p-10 text-xl text-center rounded">
        <p className="font-hack">I'm an aspiring backend developer</p>
      </div>
    </div>
  )
}
